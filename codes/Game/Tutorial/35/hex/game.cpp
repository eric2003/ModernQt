...
void Game::displayGameOverWindow(QString message)
{
    ...
    this->drawPanel(0,0,1024,768,Qt::black,0.65);

    // draw panel
    this->drawPanel(312,184,400,400,Qt::lightGray,0.75);

    // create play again button
    Button * playAgainButton = new Button(QString("Play Again"));
    playAgainButton->setPos(410,300);
    this->scene->addItem(playAgainButton);
    QObject::connect(playAgainButton,&Button::clicked,this,&Game::restartGame);
