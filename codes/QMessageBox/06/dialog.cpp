...
{
    errMsg->showMessage( tr( "MESSAGE" ), tr( "OK" ) );
    ui->labelMsgBoxShowMsg->setText( tr( "MESSAGE" ) );
}

void Dialog::on_btnMsgBoxShowMsg1_clicked()
{
    //errMsg->showMessage( tr( "MESSAGE" ), tr( "OK1" ) );
    errMsg->showMessage( tr( "MESSAGE" ), tr( "OK" ) );
    ui->labelMsgBoxShowMsg1->setText( tr( "MESSAGE" ) );
}